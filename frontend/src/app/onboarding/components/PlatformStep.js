  ...
  return (
    <div className="w-full max-w-2xl">
      ...
      <button
        ...
        className="w-full py-3 rounded-xl bg-werbens-dark-cyan text-werbens-alt-text font-medium hover:bg-werbens-dark-cyan/90 disabled:opacity-50 disabled:cursor-not-allowed transition"
      >
        Continue
      </button>
    </div>
